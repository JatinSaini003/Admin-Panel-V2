...
{/* ------------------ Progress Card ------------------ */ }
const DashboardProgressCard: React.FC<DashboardProgressCardProps> = ({ data }) => {
    return (
        <div className="bg-background-default border border-border-muted rounded-xl p-4 flex flex-col items-center shadow-sm">
